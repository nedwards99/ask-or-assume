...
from openhands.agenthub.clarify_agent_v2.tools import (
    BrowserTool,
    ClarifyTool,
...
from openhands.agenthub.clarify_agent_v2.tools.security_utils import RISK_LEVELS
    ...
    if hasattr(assistant_msg, 'tool_calls') and assistant_msg.tool_calls:
        ...
        for i, tool_call in enumerate(assistant_msg.tool_calls):
            ...
            # ================================================
                ...
                delegate_agent = arguments.get('agent', 'BrowsingAgent')
                delegate_inputs = {
                    key: value for key, value in arguments.items() if key != 'agent'
                }
            ...
            elif tool_call.function.name == IntentAgentDelegateTool['function']['name']:
                action = AgentDelegateAction(
                    agent='IntentAgent',
                    inputs=arguments,
                )
            ...
            # ================================================
                ...
                if questions:
                    ...
                    for i, q in enumerate(questions, 1):
                        ...
                        #         default_marker = " ← (recommended)" if opt == default else ""
